...
/** Integration tests for MySQL development metadata and native SQL definitions. */
@Test(singleThreaded = true)
public class MySqlConnectorIntegrationTest {

    private MySqlDatabaseInitializer database;
    private TestMySqlConnector connector;

    private static final class TestMySqlConnector
    ...
    public void setUp() throws Exception {
        ...
        configuration.setJdbcUrl(MySqlDatabaseInitializer.JDBC_URL);
        configuration.setUsername(MySqlDatabaseInitializer.USERNAME);
        configuration.setPassword(new GuardedString(
                MySqlDatabaseInitializer.PASSWORD.toCharArray()));
        ...
        connector = new TestMySqlConnector();
    ...
    @Test
    public void exportsMySqlTableMetadataAndNativeDefinition() throws Exception {
    ...
    @Test
    public void exportsMySqlViewDefinition() throws Exception {
