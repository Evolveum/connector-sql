...
public final class MariaDbDatabaseInitializer implements AutoCloseable {
    ...
    public static final String JDBC_URL = "jdbc:mariadb://localhost:3307/connector_sql";
    public static final String USERNAME = "connector";
    public static final String PASSWORD = "connector123";
